...
#define clock0_Pin GPIO_PIN_0
#define clock0_GPIO_Port GPIOB
#define clock1_Pin GPIO_PIN_1
#define clock1_GPIO_Port GPIOB
#define clock2_Pin GPIO_PIN_2
...
#define s0_EXTI_IRQn EXTI15_10_IRQn
#define clock3_Pin GPIO_PIN_3
#define clock3_GPIO_Port GPIOB
